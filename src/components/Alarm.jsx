...
export default function Alarm() {
  ...
  let deleteAlarmList = (id) => {
    let newArray = alarmList.filter((el, i) => {
      if (id == i) {
        return false;
      }
      return true;
  ...
  return (
    <div>
      <div style={{ width: "70%", margin: "20px auto", border: "2px solid black", padding: "10px" }}>
        <label htmlFor="input-value" style={{ fontSize: "20px", marginRight: "10px" }}>Select Time</label>
      ...
      <div style={{ width: "70%", margin: "20px auto" }}>
        {alarmList.map((el, i) => {
          return <AlarmLook key={i} {...el} id={i} handleDeleteFunction={deleteAlarmList} />
        })}
      </div>
